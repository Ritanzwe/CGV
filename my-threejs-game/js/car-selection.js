...
const dummyBody=new CANNON.Body({
    ...
    position:new CANNON.Vec3(dummyMesh.position.x,dummyMesh.position.y,dummyMesh.position.z)
});
...
class CarControls {
    constructor(car) {
        ...
        this.body = new CANNON.Body({
            mass: 150,
            position: new CANNON.Vec3(this.car.position.x, this.car.position.y, this.car.position.z),
            shape: shape,
            fixedRotation: true,
            linearDamping:0.1,
